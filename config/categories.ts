import { 
  ...
  export const categories = [
    ...
    },
    {
      ...
      icon: Cloud,
      color: 'bg-sky-500/10 hover:bg-sky-500/20 border-sky-500/20 data-[state=checked]:border-sky-500 data-[state=checked]:text-sky-500'
    },
    {
      id: 'version-control',
    ...
    },
    {
      ...
      icon: Briefcase,
      color: 'bg-amber-500/10 hover:bg-amber-500/20 border-amber-500/20 data-[state=checked]:border-amber-500 data-[state=checked]:text-amber-500'
    },
    {
      id: 'marketing',
      label: 'Marketing',
    ...
    },
    {
      ...
      icon: BookOpen,
      color: 'bg-red-500/10 hover:bg-red-500/20 border-red-500/20 data-[state=checked]:border-red-500 data-[state=checked]:text-red-500'
    },
    {
      id: 'photography',
      label: 'Photography',
