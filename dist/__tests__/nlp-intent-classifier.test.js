"use strict";
/**
 * Test script for NlpIntentClassifier
 * Tests the classifier with 5 example inputs
 */
Object.defineProperty(exports, "__esModule", { value: true });
const NlpIntentClassifier_1 = require("../app/services/chat/NlpIntentClassifier");
async function runTests() {
    console.log('🚀 Starting NlpIntentClassifier Tests\n');
    // Initialize classifier
    const classifier = new NlpIntentClassifier_1.NlpIntentClassifier('./models/test-intents.nlp');
    // Add test intents
    ...
    const testCases = [
        ...
        { input: 'how are you doing', expectedIntent: 'unknown' }, // Should fallback to unknown
