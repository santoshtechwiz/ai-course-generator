      ...
      return (
        <Card className={cn("h-full overflow-hidden border border-border/50", className)}>
          <div className="animate-pulse">
            <div className="w-full aspect-[16/10] bg-gradient-to-br from-muted to-muted/50 rounded-t-lg" />
            ...
            <CardContent className="py-0 px-4 sm:px-6 flex-1">
              <motion.div variants={contentVariants} className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-2 sm:gap-4">
                  {[
                    { icon: BookOpen, label: "Units", value: unitCount, color: "text-blue-500" },
                    { icon: Users, label: "Lessons", value: lessonCount, color: "text-green-500" },
                    { icon: FileQuestion, label: "Quizzes", value: quizCount, color: "text-purple-500" },
                  ].map((stat, index) => (
                    <motion.div
                      key={index}
                      whileHover={{ scale: 1.05, y: -2 }}
                      className="flex flex-col items-center gap-1.5 p-3 rounded-xl bg-gradient-to-br from-muted/50 to-muted/30 hover:from-primary/5 hover:to-primary/10 transition-all duration-300"
                    >
