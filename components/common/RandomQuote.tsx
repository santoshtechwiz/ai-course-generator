    ...
    <div className="relative overflow-hidden rounded-lg w-full border border-border/50 shadow-sm bg-background/80 backdrop-blur-sm py-2 px-3">
      ...
      <div className="relative">
        <AnimatePresence mode="wait" custom={direction}>
          ...
          >
            <motion.p className="text-sm font-medium text-foreground italic">"{quotes[currentIndex].text}"</motion.p>
            <motion.div className="text-xs text-muted-foreground mt-1">– {quotes[currentIndex].author}</motion.div>
          </motion.div>
        </AnimatePresence>
