...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-none text-base font-semibold border-2 border-border transition-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 relative overflow-hidden",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-destructive text-destructive-foreground shadow-[var(--shadow)] hover:translate-x-[3px] hover:translate-y-[-3px] hover:shadow-none active:translate-x-[4px] active:translate-y-[-4px]",
        outline:
          "bg-background text-foreground shadow-[var(--shadow)] hover:translate-x-[3px] hover:translate-y-[-3px] hover:shadow-none",
        secondary:
          "bg-secondary text-secondary-foreground shadow-[var(--shadow)] hover:translate-x-[3px] hover:translate-y-[-3px] hover:shadow-none",
        ...
        success: "bg-success text-success-foreground shadow-[var(--shadow)] hover:translate-x-[3px] hover:translate-y-[-3px] hover:shadow-none",
        warning: "bg-warning text-warning-foreground shadow-[var(--shadow)] hover:translate-x-[3px] hover:translate-y-[-3px] hover:shadow-none",
      },
      size: {
