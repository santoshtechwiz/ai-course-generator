...
import { extractKeywords, generateMetaDescription, optimizeImageAlt } from './utils';

/**
 * SEO Manager - Metadata generation
 * 
 * This file contains functions for generating metadata for pages.
 * It provides a centralized way to handle SEO metadata across the application.
 */
 ...
 * @param props Next.js page props with params
 * @param fetchData Function to fetch data for metadata
 * @returns Next.js Metadata object
 */
 ...
 * @param quizType Quiz type string
