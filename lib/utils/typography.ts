...
export const typography = {
  ...
  display: {
    large: "text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight leading-none",
    medium: "text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight leading-tight",
    small: "text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold tracking-tight leading-tight"
  },
...
export const getTypography = (category: keyof typeof typography, variant: string) => {
...
export const textPatterns = {
  ...
  tableHeader: "text-xs sm:text-sm font-medium text-muted-foreground uppercase tracking-wide",
