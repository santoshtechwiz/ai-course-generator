...
// Create a global singleton cache instance across HMR/serverless invocations
const globalForCache = globalThis as unknown as {
	__appNodeCache?: NodeCache
}

if (!globalForCache.__appNodeCache) {
	globalForCache.__appNodeCache = new NodeCache({
...
const globalCache = globalForCache.__appNodeCache
