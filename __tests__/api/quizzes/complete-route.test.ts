...
import { POST, QuizCompletionResponse } from '@/app/api/quizzes/common/[slug]/complete/route';
...
const expectWithDebug = async (response: NextResponse<QuizCompletionResponse>, statusCode: number) => {
