...
import { subscriptionSlice, fetchSubscription, forceSyncSubscription } from '@/store/slices/subscription-slice'
...
describe('Subscription Slice', () => {
  ...
  describe('Selectors', () => {
    ...
    it('should calculate token usage correctly', () => {
      ...
      // Import the selector to test
      const { selectTokenUsage } = require('@/store/slices/subscription-slice')
    ...
    it('should detect active subscription correctly', () => {
      ...
      // Import the selector to test
      const { selectHasActiveSubscription } = require('@/store/slices/subscription-slice')
