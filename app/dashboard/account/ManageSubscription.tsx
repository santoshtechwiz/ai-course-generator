...
import { PaymentMethodForm } from "./component/PaymentMethod"
...
export function ManageSubscription({ userId, subscriptionData }: ManageSubscriptionProps) {
  ...
  const { currentPlan, subscriptionStatus, endDate, tokensUsed,
     paymentMethods = [], totalTokens } = subscriptionData
