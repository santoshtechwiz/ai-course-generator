...
export const metadata: Metadata = {
  title: "Explore AI-Powered Course Creation Tools | Course AI",
  description:
  ...
  openGraph: {
    title: "AI-Powered Course Creation Tools | Course AI",
  ...
  twitter: {
    ...
    title: "Explore AI Course Creation Tools | Course AI",
