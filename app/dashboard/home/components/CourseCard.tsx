...
import { BookIcon, UsersIcon, FileQuestionIcon, StarIcon, EyeIcon } from "lucide-react"
...
export const CourseCard: React.FC<CourseCardProps> = React.memo(
  ({ name, description, image, rating, slug, unitCount, lessonCount, quizCount, viewCount }) => {
    return (
      <Card className="flex flex-col h-full overflow-hidden transition-all duration-300 hover:shadow-lg w-full sm:max-w-md bg-card">
