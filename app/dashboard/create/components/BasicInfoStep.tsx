...
export function BasicInfoStep({ control, errors, params }: BasicInfoStepProps) {
  return (
    <div className="space-y-6 md:space-y-8 max-w-2xl mx-auto">
      {/* Engaging intro card */}
      <div className="bg-gradient-to-r from-warning via-accent to-primary border-4 border-border rounded-xl p-4 md:p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2">
          <div className="p-1.5 md:p-2 bg-primary border-3 border-border rounded-none shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
        ...
        {errors.title && (
          <div className="flex items-center gap-2 bg-error/10 border-3 border-error rounded-none p-3 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]">
            <AlertCircle className="h-4 w-4 text-error flex-shrink-0" />
            <p className="text-xs md:text-sm text-error font-bold">{errors.title.message}</p>
          </div>
        )}
        
        <p className="text-xs md:text-sm text-muted font-bold flex items-center gap-2">
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2">
          <div className="p-1.5 md:p-2 bg-secondary border-3 border-border rounded-none shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
        ...
        {errors.description && (
          <div className="flex items-center gap-2 bg-error/10 border-3 border-error rounded-none p-3 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]">
            <AlertCircle className="h-4 w-4 text-error flex-shrink-0" />
            <p className="text-xs md:text-sm text-error font-bold">{errors.description.message}</p>
          </div>
        )}
        
        <div className="bg-primary/5 border-3 border-primary rounded-none p-3 md:p-4">
          <p className="text-xs md:text-sm font-bold text-primary mb-2">💡 Pro Tips:</p>
          <ul className="space-y-1 text-xs md:text-sm text-primary/80 font-medium">
            <li className="flex items-start gap-2">
              <span className="inline-block w-1.5 h-1.5 bg-primary rounded-full mt-1.5 flex-shrink-0"></span>
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2">
          <div className="p-1.5 md:p-2 bg-success border-3 border-border rounded-none shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
            <Tag className="h-4 w-4 md:h-5 md:w-5 text-foreground" />
          </div>
        ...
        {errors.category && (
          <div className="flex items-center gap-2 bg-error/10 border-3 border-error rounded-none p-3 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]">
            <AlertCircle className="h-4 w-4 text-error flex-shrink-0" />
            <p className="text-xs md:text-sm text-error font-bold">{errors.category.message}</p>
          </div>
        )}
