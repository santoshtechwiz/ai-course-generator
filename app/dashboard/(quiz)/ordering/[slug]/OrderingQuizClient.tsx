...
const OrderingQuizWrapper = lazy(() => import('./components/OrderingQuizWrapper'))
const QuizPlayLayout = lazy(() => import('../../components/layouts/QuizPlayLayout'))

interface OrderingQuizClientProps {
  params: Promise<{ slug: string }>
}

export default function OrderingQuizClient({ params }: OrderingQuizClientProps) {
  ...
  return (
    <Suspense fallback={<PageLoader message={LOADER_MESSAGES.LOADING_QUIZ} />}>
      <QuizPlayLayout
        quizSlug={slug}
        quizType="quiz"
        quizId={slug}
