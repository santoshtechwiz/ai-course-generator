      ...
      >
        <div className="w-full h-full space-y-4 sm:space-y-6">
          ...
          {question.codeSnippet && (
            ...
            >
              <div className="bg-gradient-to-r from-slate-900 via-gray-900 to-slate-900 px-3 sm:px-4 py-2 sm:py-3 flex items-center justify-between">
              ...
              <div className="relative overflow-hidden max-h-[300px] sm:max-h-[400px] overflow-y-auto">
                <SyntaxHighlighter
          ...
          <motion.div
            ...
            className="mx-2 sm:mx-4"
          >
            <Card className="w-full h-full border-0 shadow-lg bg-gradient-to-br from-card to-card/80 overflow-hidden">
              <div className={`h-1 bg-gradient-to-r ${languageGradient}`}></div>
              <CardContent className="w-full h-full p-4 sm:p-6 md:p-8">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-muted/50 rounded-full text-xs sm:text-sm text-muted-foreground">
