    ...
    <div className="space-y-10">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
        <div className="space-y-4">
          ...
          <Skeleton className={cn("h-6 w-56 rounded-none", cardPrimary)} />
        </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6">
            {Array.from({ length: 5 }).map((_, i) => (
              ...
              >
                ...
                <Skeleton className={cn("h-5 w-24 mx-auto rounded-none", cardPrimary)} />
              </motion.div>
            ))}
          </div>
        </CardContent>
          ...
          >
            <Card className={cn("h-full overflow-hidden rounded-xl", cardPrimary)}>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-3">
                      <Skeleton className={cn("h-7 w-28 rounded-none", cardPrimary)} />
                      <Skeleton className={cn("h-5 w-36 rounded-none", cardPrimary)} />
                    </div>
                  </div>
              ...
              <CardContent className="space-y-6 px-6">
                <div className="space-y-4">
                  <Skeleton className={cn("h-8 w-full rounded-none", cardPrimary)} />
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <Skeleton className={cn("h-6 w-6 rounded", cardPrimary)} />
                      <Skeleton className={cn("h-6 w-14 rounded-none", cardPrimary)} />
                      <Skeleton className={cn("h-5 w-20 rounded-none", cardPrimary)} />
                    </div>
                    <Skeleton className={cn("h-6 w-24 rounded-none", cardPrimary)} />
                  </div>
                </div>

                <div className="space-y-3">
                  <Skeleton className={cn("h-5 w-full rounded-none", cardPrimary)} />
                  <Skeleton className={cn("h-5 w-4/5 rounded-none", cardPrimary)} />
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 py-5 border-y-3 border-border">
                  {Array.from({ length: 3 }).map((_, i) => (
                    <div key={i} className="flex flex-col items-center gap-3">
                      ...
                      <Skeleton className={cn("h-4 w-14 rounded-none", cardPrimary)} />
                    </div>
                  ))}
                </div>

                <div className="flex items-center justify-between">
                  <Skeleton className={cn("h-6 w-28 rounded-none", cardPrimary)} />
                  <Skeleton className={cn("h-6 w-32 rounded-none", cardPrimary)} />
                </div>
              ...
              <CardFooter className="pt-0 px-6 pb-6">
                <div className="flex items-center justify-between w-full">
                  <div className="flex items-center gap-5">
                    <Skeleton className={cn("h-6 w-20 rounded-none", cardPrimary)} />
