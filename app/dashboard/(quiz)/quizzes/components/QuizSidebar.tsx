...
import { FileQuestion, AlignJustify, PenTool, Code, Flashlight, Filter, X, ChevronDown, SearchIcon } from "lucide-react"
  ...
  const getTypeColorClasses = (type: QuizType, isSelected: boolean) => {
    const colorMap = {
      ...
      flashcard: isSelected
        ...
        : "bg-pink-50 text-pink-700 hover:bg-pink-100 border-pink-200 dark:bg-pink-900/20 dark:text-pink-300 dark:border-pink-800",
    }
          ...
          >
            ...
            {onQuestionCountChange && (
              <motion.div className="pt-4 space-y-3" variants={itemVariants}>
                ...
                <div className="px-2">
                  <Slider
                    defaultValue={[localQuestionCount[0], localQuestionCount[1]]}
                    max={50}
                    step={1}
