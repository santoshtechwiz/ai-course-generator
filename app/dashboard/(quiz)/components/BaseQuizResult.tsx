 ...
 * Uses render props pattern to allow for customization by child components
 */
export function BaseQuizResult<T extends BaseQuizResultProps>({
  ...
  const filteredQuestions = useMemo(() => {
    ...
    if (filterType === 'correct') {
      ...
      // 'all' or any other value shows all questions
    }
  ...
  const handleRetry = useCallback(() => {
    if (onRetake) {
      ...
      // Determine quiz type from the URL to route correctly
