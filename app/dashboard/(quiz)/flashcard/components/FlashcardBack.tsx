...
export function FlashcardBack({
  ...
  return (
    ...
    >
      ...
      >
          ...
          >
            {isSaved ? (
              <Heart className="w-4 h-4 sm:w-5 sm:h-5 mx-auto fill-current text-[var(--color-bg)]" />
            ) : (
              <Heart className="w-4 h-4 sm:w-5 sm:h-5 mx-auto text-[var(--color-text)]" />
            )}
          </motion.button>
  ...
  {/* Answer Content */}
  <div className="flex-1 flex flex-col justify-center space-y-2 sm:space-y-3 mb-3 sm:mb-4">
          ...
          {explanation && (
            <div className="bg-muted border-2 sm:border-3 border-border shadow-neo p-3 sm:p-4 mx-2 sm:mx-3 rounded-lg">
              <div className="flex items-center gap-2 mb-3">
                  ...
                  <h4 className="text-xs sm:text-sm font-bold text-[var(--color-text)]">Explanation</h4>
              </div>
          ...
          <div className="text-center px-2">
            <div className="inline-flex flex-wrap items-center justify-center gap-2 sm:gap-4 px-4 sm:px-6 py-2 sm:py-3 bg-[var(--color-card)] border-3 sm:border-4 border-[var(--color-border)] shadow-neo-sm rounded-lg">
              {[
                ...
                <span key={shortcut.key} className="flex items-center gap-1.5 sm:gap-2 text-xs font-black text-[var(--color-text)]">
                  <kbd className="px-1.5 sm:px-2 py-0.5 sm:py-1 bg-[var(--color-bg)] border-2 border-[var(--color-border)] text-xs font-black rounded-sm shadow-neo-sm">
                    {shortcut.key}
                  </kbd>
