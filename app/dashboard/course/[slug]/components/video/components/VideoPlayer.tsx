        ...
        <CardContent className="p-4 space-y-3">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-muted-foreground truncate">{nextVideoTitle || "Loading..."}</p>
            </div>
          </div>
...
const VideoPlayer: React.FC<VideoPlayerProps> = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn("relative bg-black rounded-lg overflow-hidden group aspect-video", className)}
    ...
    >
      ...
      <AnimatePresence>
        {!isPlaying && !isLoading && (
          ...
          >
            <Button size="lg" onClick={togglePlay} className="w-16 h-16 rounded-full bg-primary/80 hover:bg-primary">
                  ...
                  <Button
                    ...
                    onClick={async () => {
                      try {
                        ...
                        if (videoEl && (videoEl as any).requestPictureInPicture) {
                          await (videoEl as any).requestPictureInPicture()
                        } else {
                          toast({
                            title: "Picture-in-Picture Unavailable",
                            description: "This browser doesn't support Picture-in-Picture mode.",
                            variant: "destructive",
                          })
                        }
                      } catch (error) {
                        ...
                        toast({
                          ...
                          description: "Unable to activate Picture-in-Picture mode.",
                          variant: "destructive",
                        })
                      }
                    }}
