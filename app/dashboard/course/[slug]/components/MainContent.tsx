...
import { ArrowLeft, ArrowRight, BookOpen, CheckCircle, Bookmark, Loader2, Lock } from "lucide-react"
    ...
    <div className="flex flex-col w-full">
      <div className="relative rounded-lg overflow-hidden border border-border">
        {initialVideoId ? (
          ...
          <div className="flex items-center justify-center w-full aspect-video bg-card rounded-lg">
        ...
        <div className="flex justify-between items-center p-3 bg-muted/30 border-t">
          <Button
            variant="ghost"
            size="sm"
            onClick={handlePrevVideo}
            disabled={!prevVideoId}
            className={cn(!prevVideoId && "opacity-50 cursor-not-allowed")}
          >
          ...
          <Button
            ...
            disabled={!nextVideoId && !isLastVideo}
            className={cn(!nextVideoId && !isLastVideo && "opacity-50 cursor-not-allowed")}
          >
            Next
      ...
      <div className="p-4 md:p-6">
        ...
        <div ref={tabsRef}>
          <Tabs defaultValue="overview" value={activeTab} onValueChange={handleTabChange} className="w-full">
            <TabsList className="grid grid-cols-3 mb-6 bg-card/50 border border-border/30 rounded-lg p-1">
              <TabsTrigger
                value="overview"
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <TabsContent value="overview" className="space-y-4 bg-card/20 rounded-lg p-4">
                  {renderTabContent()}
                </TabsContent>
                <TabsContent value="notes" className="bg-card/20 rounded-lg p-4">
                  {renderTabContent()}
                </TabsContent>
                <TabsContent value="quiz" className="bg-card/20 rounded-lg p-4">
                  {renderTabContent()}
                </TabsContent>
              </motion.div>
            </AnimatePresence>
