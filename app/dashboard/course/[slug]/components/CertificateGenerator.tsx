...
const CertificateGenerator: React.FC<CertificateGeneratorProps> = ({
  ...
  }, [effectiveUserName, safeCourseName, toast])
  ...
  return (
    <div className="flex flex-col items-center space-y-4 p-6 bg-primary/5 rounded-lg border border-primary/20">
      ...
      {showSuccess && (
        <div className="bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300 px-4 py-2 rounded-md text-sm flex items-center mb-2 w-full">
