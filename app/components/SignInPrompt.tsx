...
export const SignInPrompt: React.FC = () => {
  return (
    ...
    >
      <Card className="mt-4">
        <CardHeader>
          <CardTitle className="text-xl font-bold text-center">Sign In to View Results</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-center text-gray-600 mb-4">
            To see your quiz results and track your progress, please sign in or create an account.
          </p>
