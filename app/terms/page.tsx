...
export default function TermsAndConditions() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="mb-4">
        Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using the courseai.io
        website (the "Service") operated by CourseAI ("us", "we", or "our").
      </p>
      ...
      <p className="mb-4">
        Our Service integrates third-party services, including but not limited to YouTube and Google Gemini. By using
      ...
      <ul className="list-disc pl-8 mb-4">
        ...
        <li>
          CourseAI is not responsible for any interruptions, errors, or issues arising from the use of these third-party
          services.
        </li>
        <li>
          We do not guarantee the accuracy, completeness, or availability of content provided through these services.
        </li>
      ...
      <p className="mb-4">
        The content displayed on our Service, including videos and educational materials, is primarily sourced from
        YouTube and other third-party platforms. CourseAI does not claim ownership of this content and respects the
        intellectual property rights of the content creators.
      </p>

      <p className="mb-4">
        If you believe that any content on our Service infringes upon your intellectual property rights, please contact
        us immediately with the relevant details.
      </p>
      ...
      <ul className="list-disc pl-8 mb-4">
        ...
        <li>
          Users should not rely solely on AI-generated content for critical decisions, including but not limited to
          legal, medical, financial, or educational matters.
        </li>
        <li>
          CourseAI does not guarantee the accuracy or reliability of AI-generated content and is not liable for any
          damages arising from reliance on such content.
        </li>
      </ul>
      ...
      <p className="mb-4">
        To the maximum extent permitted by law, CourseAI shall not be liable for any indirect, incidental, special,
      ...
      <p className="mb-4">
        CourseAI reserves the right to modify or discontinue, temporarily or permanently, the Service (or any part
      ...
      <p className="mb-4">
        ...
        by posting the new Terms and Conditions on this page. Your continued use of the Service after any modifications
        constitutes acceptance of the new Terms.
      </p>

      <h2 className="text-2xl font-semibold mt-6 mb-4">10. Contact Us</h2>

      <p className="mb-4">If you have any questions about these Terms, please contact us at support@courseai.io.</p>
