...
async function fetchAndGenerateQuiz(videoId: string, chapterId: number, chapterName: string): Promise<string> {
  try {
...
async function generateQuizInternal(transcript: string, chapterId: number, chapterName: string): Promise<string> {
  try {
    const maxLength = 500
