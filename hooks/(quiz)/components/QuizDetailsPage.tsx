...
export default function QuizDetailsPage({
  ...
  // Log component rendering to track data flow
  console.log("Rendering QuizDetailsPage:", {
    title,
    slug,
    quizType,
    questionCount,
  ...
  // Memoize the difficulty configuration to prevent unnecessary re-renders
  ...
  // Memoize the quiz type styles to prevent unnecessary re-renders
  const quizTypeStyles = useMemo(
    () => ({
            ...
            <Card className="overflow-hidden border shadow-md hover:shadow-lg transition-shadow duration-300">
              <CardHeader className="bg-gradient-to-r from-muted/30 to-muted/10 border-b space-y-4">
                ...
                >
                  <Badge
                    variant="outline"
                    className={cn("px-2.5 py-1 text-xs font-medium rounded-full border", quizTypeStyles[quizType])}
                  >
                      ...
                      <TooltipTrigger asChild>
                        <Badge
                          ...
                          className={cn(
                            ...
                            difficultyConfig[difficulty].bgLight,
                            difficultyConfig[difficulty].bgDark,
                            difficultyConfig[difficulty].borderLight,
                            difficultyConfig[difficulty].borderDark,
                            difficultyConfig[difficulty].textLight,
                            difficultyConfig[difficulty].textDark,
                          )}
                        >
                          <div className="flex">
